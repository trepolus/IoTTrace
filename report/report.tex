...
With datasets from IOT traces on taxis acquired by INSA Lyon, we set out to find interesting human behaviours or patterns to act on with this data. This data includes the  taxi I.D., longitude, latitude, speed, angle, date/time and the number of passengers. You will see how we chose our data and what patterns and behaviours we found. And with this what we chose to do with this information.
...
\end{center}
\caption{\label{fig:w pass 0-12 6h&12h}Heatmaps without passengers; left top 0-6 a.m., right top: 6-12 a.m., right bottom: 0-12a.m.}
\end{figure}
